...
public class ReturnModel {    public Double Selling_Price ;
    ...
    public ReturnModel(Double selling_Price, String itemName, String barcode) {
        Selling_Price = selling_Price;
        ItemName = itemName;
        Barcode = barcode;
    }

    public ReturnModel(Double selling_Price, String itemName, String barcode, int documentType) {
        Selling_Price = selling_Price;
        ItemName = itemName;
        Barcode = barcode;
